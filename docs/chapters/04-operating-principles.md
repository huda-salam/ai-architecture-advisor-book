...
They apply across both executive advisory work and deep technical review. The advisor's independence is credible only when it is grounded in technical understanding.
...
## 4.3 Technical Depth Before Technical Challenge

Do not challenge a technical proposal superficially.

Before disagreeing, understand:

- what the system actually does;
- why the architecture was proposed;
- which technical mechanisms make it work;
- which assumptions it depends on;
- what evidence supports it;
- what alternatives were considered.

> **Earn the right to dissent through understanding.**
...
## 4.5 Prefer Simplicity When Sufficient
...
## 4.6 Do Not Build What Can Safely Be Bought

Building technology internally can create engineering cost, operational burden, security responsibility, maintenance obligations and slower time to value.
...
## 4.7 Do Not Buy What Creates Unacceptable Dependency

The opposite principle is equally important.

A service may be technically excellent but strategically problematic if it creates excessive dependency in data, model behavior, proprietary formats, APIs, identity, workflows, pricing, or operational processes.
...
## 4.9 Source Systems Remain Authoritative
...
## 4.10 AI Is Not Automatically the Right Tool
...
## 4.11 Human Accountability for Consequential Decisions
...
## 4.13 Separate Capability From Reliability
...
## 4.14 Make Cost a First-Class Architecture Dimension
...
## 4.15 Make Assumptions Explicit

A technical recommendation is often conditional.

Record workload, data-volume, latency, security, model-performance, organizational and cost assumptions.

An assumption that materially affects the recommendation should be testable.

## 4.16 Know What Would Change Your Mind
...
## 4.17 Be Vendor-Neutral, Not Vendor-Blind
...
## 4.18 Challenge the Assumption, Not the Person

A technical disagreement should focus on requirement, assumption, evidence, architecture, trade-off and risk—not seniority, personality, ownership or organizational politics.

> **Attack the reasoning, not the person.**

## 4.19 Second Opinion Is a Valid Output
...
The second opinion should explain where the views agree, where they differ, why they differ, the evidence supporting the difference, the recommendation, confidence, and what would change the view.

## 4.20 Dissent Is a Professional Responsibility When Material
...
4. Do I understand the technical mechanism well enough to challenge it?
5. What alternatives exist?
6. Why is this architecture preferable?
7. What can fail?
8. How is it secured?
9. How does it scale?
10. What does it cost in total?
11. How difficult is it to change or exit?
12. What evidence supports the conclusion?
